<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($mail->send()) {
            ...
            <body>
             <h1 style="font-size:30px;color:#cde1f;">KATEC</h1>
                                      
             <p style="font-size:15px;color:black;">Bonjour <b>'.$nom.'</b><br> Merci infiniment de nous avoir contactés sur notre site !<br> 
              Nous sommes ravis de votre intérêt et sommes prêts à répondre à
               toutes vos questions. <br>À bientôt !
              <br><br>
                Cordialement,<br>
              KATEC </p>
